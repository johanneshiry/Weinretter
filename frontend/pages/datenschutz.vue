  ...
  <div class="imp">
    <div class="container">
      ...
      <p>
        ...
        Geschäftsleitung der Decker Internet UG (haftungsbeschränkt). Eine
        Nutzung der Internetseiten der Decker Internet UG (haftungsbeschränkt)
      ...
      <p>
        ...
        Übereinstimmung mit den für die Decker Internet UG (haftungsbeschränkt)
      ...
      <p>
        Die Decker Internet UG (haftungsbeschränkt) hat als für die Verarbeitung
      ...
      <p>
        Die Datenschutzerklärung der Decker Internet UG (haftungsbeschränkt)
      ...
      <h4>3. Cookies</h4>
      <p>
        Die Internetseiten der Decker Internet UG (haftungsbeschränkt) verwenden
      ...
      <p>
        Durch den Einsatz von Cookies kann die Decker Internet UG
        (haftungsbeschränkt) den Nutzern dieser Internetseite
      ...
      <p>
        Die Internetseite der Decker Internet UG (haftungsbeschränkt) erfasst
      ...
      <p>
        ...
        Decker Internet UG (haftungsbeschränkt) keine Rückschlüsse auf die
        ...
        erhobenen Daten und Informationen werden durch die Decker Internet UG
      ...
      <ul style="list-style: none;">
        ...
        <li>
          ...
          <p>
            ...
            Person die Löschung von personenbezogenen Daten, die bei der Decker
            Internet UG (haftungsbeschränkt) gespeichert sind, veranlassen
            möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für
            die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Decker
            Internet UG (haftungsbeschränkt) wird veranlassen, dass dem
            Löschverlangen unverzüglich nachgekommen wird.
          </p>

          <p>
            Wurden die personenbezogenen Daten von der Decker Internet UG
            (haftungsbeschränkt) öffentlich gemacht und ist unser Unternehmen
            als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
            personenbezogenen Daten verpflichtet, so trifft die Decker Internet
            UG (haftungsbeschränkt) unter Berücksichtigung der verfügbaren
            ...
            Mitarbeiter der Decker Internet UG (haftungsbeschränkt) wird im
        ...
        <li>
          ...
          <p>
            ...
            bei der Decker Internet UG (haftungsbeschränkt) gespeichert sind,
            verlangen möchte, kann sie sich hierzu jederzeit an einen
            Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
            Mitarbeiter der Decker Internet UG (haftungsbeschränkt) wird die
        ...
        <li>
          ...
          <p>
            ...
            betroffene Person jederzeit an einen Mitarbeiter der Decker Internet
            UG (haftungsbeschränkt) wenden.
          </p>
        </li>
        <li>
          ...
          <p>
            Die Decker Internet UG (haftungsbeschränkt) verarbeitet die
          ...
          <p>
            Verarbeitet die Decker Internet UG (haftungsbeschränkt)
            ...
            betroffene Person gegenüber der Decker Internet UG
            (haftungsbeschränkt) der Verarbeitung für Zwecke der Direktwerbung,
          ...
          <p>
            ...
            Verarbeitung personenbezogener Daten, die bei der Decker Internet UG
            (haftungsbeschränkt) zu wissenschaftlichen oder historischen
          ...
          <p>
            ...
            Person direkt an jeden Mitarbeiter der Decker Internet UG
        ...
        <li>
          ...
          <p>
            ...
            der betroffenen Person, trifft die Decker Internet UG
            (haftungsbeschränkt) angemessene Maßnahmen, um die Rechte und
